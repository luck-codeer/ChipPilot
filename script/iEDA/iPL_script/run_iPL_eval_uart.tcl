...
##   read def
#===========================================================
def_init -path $::env(RESULT_PATH)/iPL_result_uart.def

#===========================================================
##   report wire length and congestion
#===========================================================
report_wirelength -path  "$::env(RESULT_PATH)/report/eval/iPL_result_wirelength_uart.rpt"
